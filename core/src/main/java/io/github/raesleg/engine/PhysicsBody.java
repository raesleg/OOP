...
public class PhysicsBody {
    ...
    /**
     * Creates a physics body whose collision shape matches the given
     * sprite dimensions.
     *
     * @param physicsWorld the physics world that owns this body
     * @param type         static, kinematic, or dynamic
     * @param x            centre X position in Box2D meters
     * @param y            centre Y position in Box2D meters
     * @param widthPx      sprite width in pixels
     * @param heightPx     sprite height in pixels
     */
