...
public class CrosswalkCollisionHandler {
    ...
    public boolean canHandle(Entity a, Entity b) {
        return CollisionEntityUtils.extractEntity(a, b, CrosswalkZone.class) != null
    ...
    public void handleBegin(Entity entityA, Entity entityB) {
        CrosswalkZone zone = CollisionEntityUtils.extractEntity(entityA, entityB, CrosswalkZone.class);
